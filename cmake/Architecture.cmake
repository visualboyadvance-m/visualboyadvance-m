...
if(CMAKE_OSX_ARCHITECTURES
    AND (NOT CMAKE_OSX_ARCHITECTURES MATCHES "[xX]86_64;[aA][rR][mM]64")
    AND (NOT CMAKE_OSX_ARCHITECTURES MATCHES "[aA][rR][mM]64;[xX]86_64"))

    if(CMAKE_OSX_ARCHITECTURES MATCHES "[xX]86_64"      AND NOT X86_64)
        set(CMAKE_CROSSCOMPILING TRUE)
        unset(ARM64)
        set(AMD64 ON)
        set(X64 ON)
        ...
        set(WINARCH x64)
        set(ARCH_NAME x86_64)
    elseif(CMAKE_OSX_ARCHITECTURES MATCHES "[aA][rR][mM]64" AND NOT ARM64)
        set(CMAKE_CROSSCOMPILING TRUE)
        unset(AMD64)
        unset(X64)
        unset(X86_64)
