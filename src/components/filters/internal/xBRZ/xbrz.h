...
/*  -------------------------------------------------------------------------
    ...
    -------------------------------------------------------------------------
    Version: 1.9 (2026-01-24)
    - Reuse input kernels without reinterpret cast
    - Round fractional color values
    - Adjusted steep direction threshold
    - Faster xBRZ tools
...
-> support for source/target pitch in bytes! (VBA-M extension)
...
void scale(size_t factor, //valid range: 2 - SCALE_FACTOR_MAX
           ...
           ColorFormat colFmt, int srcPitch, int trgPitch, //VBA-M: pitch support restored
