...
template <class ColorGradient>
struct Scaler7x : public ColorGradient
{
    ...
    {
        //model a round corner
        alphaGrad<97, 100>(out.template ref<6, 6>(), col);
        alphaGrad<42, 100>(out.template ref<5, 6>(), col);
        alphaGrad<42, 100>(out.template ref<6, 5>(), col);
        alphaGrad< 6, 100>(out.template ref<6, 4>(), col);
        alphaGrad< 6, 100>(out.template ref<4, 6>(), col);
    }
};


template <class ColorGradient>
struct Scaler8x : public ColorGradient
{
    ...
    {
        //model a round corner
        alphaGrad<97, 100>(out.template ref<7, 7>(), col);
        alphaGrad<42, 100>(out.template ref<6, 7>(), col);
        alphaGrad<42, 100>(out.template ref<7, 6>(), col);
        alphaGrad<17, 100>(out.template ref<5, 7>(), col);
        alphaGrad<17, 100>(out.template ref<7, 5>(), col);
        alphaGrad< 6, 100>(out.template ref<7, 4>(), col);
        alphaGrad< 6, 100>(out.template ref<4, 7>(), col);
    }
};
...
struct Scaler9x : public ColorGradient
{
    ...
    {
        //model a round corner
        alphaGrad<97, 100>(out.template ref<8, 8>(), col);
        alphaGrad<42, 100>(out.template ref<7, 8>(), col);
        alphaGrad<42, 100>(out.template ref<8, 7>(), col);
        alphaGrad<17, 100>(out.template ref<6, 8>(), col);
        alphaGrad<17, 100>(out.template ref<8, 6>(), col);
        alphaGrad< 6, 100>(out.template ref<8, 5>(), col);
        alphaGrad< 6, 100>(out.template ref<5, 8>(), col);
        alphaGrad< 2, 100>(out.template ref<8, 4>(), col);
        alphaGrad< 2, 100>(out.template ref<4, 8>(), col);
    }
};
...
void xbrz::scale(size_t factor, const uint32_t* src, uint32_t* trg, int srcWidth, int srcHeight, ColorFormat colFmt, int srcPitch, int trgPitch, const xbrz::ScalerCfg& cfg, int yFirst, int yLast)
{
    ...
    static_assert(SCALE_FACTOR_MAX == 9);
    switch (colFmt)
    {
        case ColorFormat::RGB:
            switch (factor)
            {
                ...
                case 7:
                    return scaleImage<Scaler7x<ColorGradientRGB>, ColorDistanceRGB>(src, trg, srcWidth, srcHeight, srcPPitch, trgWidth, cfg, yFirst, yLast);
                case 8:
                    return scaleImage<Scaler8x<ColorGradientRGB>, ColorDistanceRGB>(src, trg, srcWidth, srcHeight, srcPPitch, trgWidth, cfg, yFirst, yLast);
                case 9:
                    return scaleImage<Scaler9x<ColorGradientRGB>, ColorDistanceRGB>(src, trg, srcWidth, srcHeight, srcPPitch, trgWidth, cfg, yFirst, yLast);
            }
            break;
        ...
        case ColorFormat::ARGB:
            switch (factor)
            {
                ...
                case 7:
                    return scaleImage<Scaler7x<ColorGradientARGB>, ColorDistanceARGB>(src, trg, srcWidth, srcHeight, srcPPitch, trgWidth, cfg, yFirst, yLast);
                case 8:
                    return scaleImage<Scaler8x<ColorGradientARGB>, ColorDistanceARGB>(src, trg, srcWidth, srcHeight, srcPPitch, trgWidth, cfg, yFirst, yLast);
                case 9:
                    return scaleImage<Scaler9x<ColorGradientARGB>, ColorDistanceARGB>(src, trg, srcWidth, srcHeight, srcPPitch, trgWidth, cfg, yFirst, yLast);
            }
            break;
        ...
        case ColorFormat::ARGB_UNBUFFERED:
            switch (factor)
            {
                ...
                case 7:
                    return scaleImage<Scaler7x<ColorGradientARGB>, ColorDistanceUnbufferedARGB>(src, trg, srcWidth, srcHeight, srcPPitch, trgWidth, cfg, yFirst, yLast);
                case 8:
                    return scaleImage<Scaler8x<ColorGradientARGB>, ColorDistanceUnbufferedARGB>(src, trg, srcWidth, srcHeight, srcPPitch, trgWidth, cfg, yFirst, yLast);
                case 9:
                    return scaleImage<Scaler9x<ColorGradientARGB>, ColorDistanceUnbufferedARGB>(src, trg, srcWidth, srcHeight, srcPPitch, trgWidth, cfg, yFirst, yLast);
            }
            break;
    }
    assert(false);
