...
template <typename T> void CheckPointer(T pointer)
{
        if (pointer == NULL) {
...
enum renderer { RND_SIMPLE, RND_OPENGL, RND_CAIRO, RND_DIRECT3D };

// likewise
enum audioapi { AUD_SDL, AUD_OPENAL, AUD_DIRECTSOUND, AUD_XAUDIO2 };
