...
void VBA::updateWindowSize(int value)
{
    ...
    if (((value >= VIDEO_320x240) && (videoOption != value)) || (videoOption >= VIDEO_320x240 && value <= VIDEO_6X) || fsForceChange) {
        fsForceChange = false;
        ...
        videoOption = value;
        if (!initDisplay()) {
            if (videoOption == VIDEO_320x240 || videoOption == VIDEO_640x480 || videoOption == VIDEO_800x600 || videoOption == VIDEO_1024x768 || videoOption == VIDEO_1280x1024 || videoOption == VIDEO_OTHER) {
    ...
    case VIDEO_OTHER: {
        ...
        if ((fullScreenStretch && (display != NULL && (display->getType() != DIRECT_3D)))
    ...
    if (autoFrameSkip) {
        if (Sm60FPS::nFrameCnt == 0) {
            ...
            if (Sm60FPS::nFrameCnt >= 10) {
                ...
                if (!Sm60FPS::bLastSkip && ((Sm60FPS::fWantFPS < Sm60FPS::K_fTargetFps) || Sm60FPS::bSaveMoreCPU)) {
