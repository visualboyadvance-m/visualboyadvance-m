...
typedef void(ALAPIENTRY* LPALLISTENER3F)(ALenum param, ALfloat value1, ALfloat value2,
    ALfloat value3);
...
typedef void(ALAPIENTRY* LPALGETLISTENER3F)(ALenum param, ALfloat* value1, ALfloat* value2,
    ALfloat* value3);
...
typedef void(ALAPIENTRY* LPALSOURCE3F)(ALuint sid, ALenum param, ALfloat value1, ALfloat value2,
    ALfloat value3);
...
typedef void(ALAPIENTRY* LPALGETSOURCE3F)(ALuint sid, ALenum param, ALfloat* value1,
...
typedef void(ALAPIENTRY* LPALBUFFERDATA)(ALuint bid, ALenum format, const ALvoid* data,
...
typedef void(ALCAPIENTRY* LPALCGETINTEGERV)(ALCdevice* device, ALCenum param, ALCsizei size,
    ALCint* dest);
