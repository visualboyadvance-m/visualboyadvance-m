#ifndef VBAM_QT_CONFIG_COMMAND_H_
#define VBAM_QT_CONFIG_COMMAND_H_
...
// A Shortcut Command is represented by a cmd::Id (see qt/cmd-ids.h).
...
public:
    ...
    static nonstd::optional<Command> FromString(const QString& name);
...
#endif  // VBAM_QT_CONFIG_COMMAND_H_
