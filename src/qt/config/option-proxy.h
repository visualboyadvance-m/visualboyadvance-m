#ifndef VBAM_QT_CONFIG_OPTION_PROXY_H_
#define VBAM_QT_CONFIG_OPTION_PROXY_H_
...
static constexpr std::array<Option::Type, kNbOptions> kOptionsTypes = {
    ...
    /*kDispDlssNr*/ Option::Type::kBool,
    /*kDispDlssNrStage*/ Option::Type::kUnsigned,
    ...
    /*kUIShowOnScreenController*/ Option::Type::kBool,
...
public:
    ...
    const QString& Get() const { return option_->GetString(); }
    bool Set(const QString& value) { return option_->SetString(value); }

    bool operator=(QString value) { return Set(value); }
    operator const QString&() const { return Get(); }
...
#endif  // VBAM_QT_CONFIG_OPTION_PROXY_H_
