...
const QString& GetGameMakerName(const std::string& makerCode) {
    static const std::unordered_map<std::string, QString> kGameMakersMap = {
        {"01", "Nintendo R&D1"},
        {"02", "Rocket Games"},
        {"08", "Capcom"},
        {"09", "Hot B Co."},
    ...
    // Localized strings.
    static const QString kUnknownMakerCode = QCoreApplication::translate("vbam", "Unknown");
    static const QString kInvalidMakerCode = QCoreApplication::translate("vbam", "Invalid");
