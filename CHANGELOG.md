...
=========================
* 12e67751 - Hopefully fix corruption in Basic Video Config [danialhorton]
* 14ea8729 - Merge remote-tracking branch 'libretro/master' into libretro-merge [rkitover]
* 704f2f19 - build: turn off tests for openssl for Mac builder [rkitover]
* badf47c0 - Merge pull request #126 from negativeExponent/libretro_fix_gb_show_border_option [105389611+LibretroAdmin]
* 6881eed0 - build: revert stable libpng for Mac builder [rkitover]
* e03f3a70 - build: change conf for libpng for Mac builder [rkitover]
* 034447fa - libretro: Fix GB Show Border option was reversed. [negativeExponent]
* ffb71108 - Merge remote-tracking branch 'upstream' [negativeExponent]
* e52744ed - Merge pull request #125 from negativeExponent/syncupstream [105389611+LibretroAdmin]
* 74a57a3a - build: set CMAKE_OSX_DEPLOYMENT_TARGET [rkitover]
* 5b91f694 - build: add SDK inc to CXXFLAGS for Mac builder [rkitover]
* 481b47a2 - build: remove fontconfig patch in Mac builder [rkitover]
* 43e1acc8 - build: use mirror for texinfo dist in Mac builder [rkitover]
* f02fdf4f - build: fix Mac builder texinfo dist version [rkitover]
* 71cb5ad0 - build: bump Mac builder dists [rkitover]
* 36cff804 - Merge remote-tracking branch 'libretro/master' into libretro-merge [rkitover]
* 1fda4f4b - Update libretro header [negativeExponent]
* d88e57f8 - Merge remote-tracking branch 'upstream' into syncupstream [negativeExponent]
* 1b4a8838 - build: check ENABLE_SDL3 for SetHint [rkitover]
* bb8a26b7 - Revert "Save current Claude state" [rkitover]
* 78cb1379 - Revert "GB: Generate V-Blank interrupt for all hardware types" [rkitover]
* ffc3e5d8 - Save current Claude state [rkitover]
* e3445c75 - Merge pull request #124 from negativeExponent/fixes [105389611+LibretroAdmin]
...
* 6a3075de - Merge remote-tracking branch 'upstream' [negativeExponent]
...
* 58c507e3 - Add .claude to .gitignore [rkitover]
* ce363a35 - GB: Generate V-Blank interrupt for all hardware types [rkitover]
* 2e0ea984 - Merge remote-tracking branch 'upstream' [negativeExponent]
...
* 7d9df484 - Add CLAUDE.md for Claude [rkitover]
* 29b35be8 - Fix Mac Homebrew and Nix builds and CI [rkitover]
* f91eba5c - translations: transifex pull [rkitover]
* af78f696 - translations: rebuild source .pot [rkitover]
...
* 5936ee09 - translations: transifex pull [rkitover]
* 9c77dfe6 - fix wiiu libretro build [eric]
* 2637b80c - Fix apple, windows libretro builds [eric]
* b517d7e8 - Merge pull request #122 from negativeExponent/sync_upstream [105389611+LibretroAdmin]
* efdb999d - translations: transifex pull [rkitover]
* 679adb81 - translations: rebuild source .pot [rkitover]
...
* 6df41670 - Merge remote-tracking branch 'upstream' into sync_upstream [negativeExponent]
* f955600c - Fix the Tile viewer for DMG in CGB mode [danialhorton]
* 4cf3ecfc - Fix DMG OBP layer in CGB and GBA modes [rkitover]
* 99cc0a1d - translations: transifex pull [rkitover]
* 3eee0483 - Fix list cheats dialog for dark mode [rkitover]
* 9551313e - Add tooltips with numerical value to all sliders [rkitover]
* cf3a48e1 - translations: transifex pull [rkitover]
* 4819adef - translations: transifex pull [rkitover]
* cb5689b2 - build: fix Intel macOS build [rkitover]
* 6e20fdc2 - build: check CMake variable ENABLE_SHARED [rkitover]
* 479a7d90 - build: add libfmt for macOS builder [rkitover]
* 3a031a01 - build: link libclang_rt.osx on macOS [rkitover]
* c34be3c7 - build: link System framework on macOS [rkitover]
* 5a21d942 - translations: transifex pull [rkitover]
* f653261f - translations: rebuild source .pot [rkitover]
* 4208f5af - Fix issues and default dev in Mac CoreAudio driver [rkitover]
* fc34bbbd - Add missing error translation in Metal driver [rkitover]
...
* 40c798ef - "Claude Code Review workflow" [rkitover]
* 63894ad3 - "Claude PR Assistant workflow" [rkitover]
* 68e7d98b - Fix pause when inactive for new wxWidgets [rkitover]
* ed1b7ff4 - translations: transifex pull [rkitover]
* ff7d1234 - translations: rebuild source .pot [rkitover]
* e889e895 - don't run Color Correct on SGB Hardware, Run GBA Color correct on GBC game run  on GBA Hardware [danialhorton]
* eb7c5001 - Revert "SDL PixelArt test fix" [rkitover]
* df66c6ff - Revert "Check file size for GBA ROM and reduce memory footprint" [rkitover]
* e0e639a0 - SDL PixelArt test fix [danialhorton]
* 5a85b2f5 - Fix out-of-bounds access [negativeExponent]
* 98937e06 - Replace crc32 with proper 256 table variant [negativeExponent]
* ede668b7 - Fixes for BSD build [brad]
* 5bd89047 - build: fix check for SDL3 pixel art filter [rkitover]
* 46326939 - translations: transifex pull [rkitover]
* 3f005837 - Rename swap16/swap32 functions which conflict with OpenBSD macros [brad]
* 2b3edb26 - translations: transifex pull [rkitover]
* 8e5fc43d - translations: transifex pull [rkitover]
* 362ca53c - translations: transifex pull [rkitover]
* 9dc10ff6 - translations: rebuild source .pot [rkitover]
...
* 9fcc0ad7 - build: fix finding static vcpkg x265 for FFmpeg [rkitover]
* 32622efc - translations: transifex pull [rkitover]
* 1dd5ba45 - translations: transifex pull [rkitover]
* 2070f759 - translations: transifex pull [rkitover]
* 89146a85 - translations: transifex pull [rkitover]
* 04395675 - translations: transifex pull [rkitover]
* e0eb3b3d - translations: transifex pull [rkitover]
...
* c5510ba2 - ci: update install-nix-action to v31 [rkitover]
* 96c23628 - Set default for gba_darken to 50 [rkitover]
* 37fb449f - Remove gbafilter_pad/gbcfilter_pad, dead code [rkitover]
* 7519c9b8 - translations: transifex pull [rkitover]
* 24b779c0 - translations: transifex pull [rkitover]
* a17df26e - build: fix Debian installdeps for current Ubuntu [rkitover]
* b2dd03c6 - build: guard cmake_policy() w if(POLICY) [rkitover]
* 967426e2 - Fix color change with previous check [andyvand]
* ee2678c1 - translations: transifex pull [rkitover]
* 337e4657 - translations: transifex pull [rkitover]
* 50079771 - Add capital begin letter [andyvand]
* 99f97138 - Add LCD filter parameters and add GBC filter [andyvand]
* 5b867c14 - Fix color name [andyvand]
* fe08f4d3 - Remove quoted code [andyvand]
* c334e3ff - Fix PS2 colors for libretro [andyvand]
* 35f8ba0b - Add libretro PlayStation2 support [andyvand]
* fca5fae3 - Check file size for GBA ROM and reduce memory footprint [andyvand]
* 56ea6456 - Check file size for GBA ROM and reduce memory footprint [andyvand]
* 0510656c - translations: transifex pull [rkitover]
* b92fcf7e - prevent the zip program from being incompletely downloaded [danialhorton]
* 22f381a1 - Update macOS SDL3 to 3.2.20 [andyvand]
* e9fc6c8e - Update macOS SDL3 to 3.2.20 [andyvand]
* bd20c790 - translations: transifex pull [rkitover]
* 203be426 - Fix typo [andyvand]
* d7507200 - Set params when no image is loaded [andyvand]
* 0e32b900 - Fix LCD color filter [andyvand]
* 26407164 - translations: transifex pull [rkitover]
* b065db66 - translations: transifex pull [rkitover]
* 4d837fd7 - translations: transifex pull [rkitover]
* 1ef356c6 - translations: transifex pull [rkitover]
* a8c82bb4 - translations: rebuild source .pot [rkitover]
* 1778d605 - Add config for color correction [rkitover]
* d6d2a83e - translations: transifex pull [rkitover]
* 881667a5 - translations: transifex pull [rkitover]
* b332aa69 - translations: rebuild source .pot [rkitover]
* 7f7035a0 - translations: finish removing German [rkitover]
* 3e355509 - build: restore FindFFmpeg.cmake [rkitover]
* e68681ff - translations: transifex pull [rkitover]
* f83aa940 - Fix GB reset [andyvand]
* a1855967 - Fix MS compile [andyvand]
* d927594a - Fix MS compile [andyvand]
* 06507775 - Replace nullptr with NULL [andyvand]
...
* 16f008b4 - Fix macOS build [andyvand]
* bad10342 - build: use pkg-config on UNIX for SDL3 [rkitover]
* 06b3cb09 - Merge pull request #1484 from Squall-Leonhart/Correct24bit [danialhorton]
* 82617ea7 - correct memory alignment [danialhorton]
* 0561ef91 - Fix CoreAudio stall [andyvand]
* afc6a1cc - build: fix build, de translation removed [rkitover]
* 35df9d76 - translations: remove German, not German [rkitover]
...
* 537393a0 - translations: transifex pull [rkitover]
* 616f7abc - translations: transifex pull [rkitover]
* f1414000 - doc: fix release commit instructions [rkitover]
