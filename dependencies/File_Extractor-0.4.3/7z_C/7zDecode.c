		...
		size_t *outSizeProcessed, ISzAlloc *allocMain)
{
	...
	{
		// TODO: encountered archive with NumCoders=2 using BJC, yet it extracted fine,
		// so I'm just going to ignore BJC for now.
		static CMethodID k_7z_BJC_x86 = { { 0x3, 0x3, 0x1, 0x3 }, 4 };
		if ( folder->NumCoders != 2 ||
				!AreMethodsEqual( &folder->Coders [1].MethodID, &k_7z_BJC_x86 ) )
			return SZE_NOTIMPL;
	}
	coder = folder->Coders;
	*outSizeProcessed = 0;
