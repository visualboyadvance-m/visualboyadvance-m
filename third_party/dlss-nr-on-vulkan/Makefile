...
work/libmetalmx$(SO): src/gpu/libmetalmx.m src/gpu/xmx.h work/metal/nr_metallib.h | work
	$(CC) $(CFLAGS) -fobjc-arc -DNR_EMBEDDED_METALLIB=1 -Isrc/gpu -Iwork/metal -shared $(INSTALL_NAME) \
